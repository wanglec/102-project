...
var PointsLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    if (state.pointsMerge) {
      ...
      var pointsGeometry = !state.pointsData.length ? new THREE$9.BufferGeometry() : BufferGeometryUtils_js.BufferGeometryUtils.mergeBufferGeometries(state.pointsData.map(function (d) {
...
var HexBinLayerKapsule = Kapsule__default['default']({
  ...
  update: function update(state) {
    ...
    if (state.hexBinMerge) {
      // merge points into a single mesh
      var hexPointsGeometry = !hexBins.length ? new THREE$7.BufferGeometry() : BufferGeometryUtils_js.BufferGeometryUtils.mergeBufferGeometries(hexBins.map(function (d) {
        var obj = d.__threeObj;
        d.__threeObj = undefined; // unbind merged points
    ...
    threeDigest(state.hexPolygonsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          obj.geometry = !hexBins.length ? new THREE$5.BufferGeometry() : BufferGeometryUtils_js.BufferGeometryUtils.mergeBufferGeometries(hexBins.map(function (h) {
            // compute new geojson with relative margin
            var relNum = function relNum(st, end, rat) {
              return st - (st - end) * rat;
            };
