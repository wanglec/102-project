...
var turfPointInPolygon = require('@turf/boolean-point-in-polygon');
...
var Delaunator__default = /*#__PURE__*/_interopDefaultLegacy(Delaunator);
var turfPointInPolygon__default = /*#__PURE__*/_interopDefaultLegacy(turfPointInPolygon);
...
function geoPolygonTriangulate(polygon) {
  ...
  var edgePoints = d3Array.merge(contour);
  ...
  var _geoBounds = d3Geo.geoBounds(boundariesGeojson),
  ...
  if (crossesPoleOrAntimeridian) {
    ...
    var vt = d3GeoVoronoi.geoVoronoi(points).triangles(); // geoDelaunay generates more triangles than needed
...
function getInnerGeoPoints(polygon, maxDistance) {
  ...
  var _geoBounds3 = d3Geo.geoBounds(boundariesGeojson),
